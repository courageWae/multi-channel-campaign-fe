...
import { useCases } from "GeoLocationMarketing/data";
...
const Card = tw.div`flex cursor-pointer flex-col items-center justify-between bg-white shadow-lg h-[380px] rounded-xl transform transition-transform hover:scale-105 duration-300 ease-in-out max-w-xs`;
