...
const Header = () => {
  return (
    <SectionContainer>
      <ContentWrapper>
        <TextWrapper>
          <Subtitle>MULTI-CHANNEL MARKETING</Subtitle>
          <Title>Bulk Messaging and Marketing Campaign </Title>
          <Description>
            The Bulk Messaging and Marketing Campaign Module of the Sevo
            Adsevo Solution provides a comprehensive suite of tools to
            execute and manage large-scale communication campaigns across
            multiple channels. This module is designed to optimize outreach
            through SMS, email, voice broadcasts, WhatsApp, and Telegram.
          </Description>
          <Description>
            It incorporates advanced features for scheduling, content creation,
            and list management, leveraging AI and automation to enhance
            campaign efficiency and effectiveness. It can be effectively applied
            across different industries to enhance communication, drive
