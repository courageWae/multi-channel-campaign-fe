                    ...
                    <div className="flex flex-col justify-between h-full">
                      ...
                      {card.properties[0].title === "Benefits" &&
                        card.properties[0].description.map((item, index) => (
                          <div key={index} className="flex-grow">
                            <ListIcon className="w-full bg-whiteshadow-md hover:shadow-lg transition duration-300 hover:scale-105 rounded-lg p-2 mb-3 h-42 flex flex-col justify-between">
                              {/* <p className="text-orange-500 font-semibold text-md mb-2">
                                <span className="text-gray-600 text-lg">
                                  {item.topHeading}
                                </span>
