      ...
      <ContentWrapper>
        <TopTitle>
          <Title>
            ...
            Benefits of Using Adsevo in the Food, agriculture and Forestry Industry
          </Title>
          <Separator />
        </TopTitle>
        <GridContainer>
...
const Card = tw.div`
  h-[400px] w-full bg-white hover:shadow-xl transition duration-500 rounded-lg p-6 border border-gray-200
`;
