    ...
    <SectionContainer>
      <ContentWrapper>
        <TextWrapper>
          ...
          <Description>
            The Adsevo platform is a versatile solution that meets the unique
            demands of the Banking and Finance sector, driving growth through
            effective marketing, customer engagement, and seamless communication
        ...
        <ImageContainer>
          <img src={Images.finance} alt="hero-illustrator" />
        </ImageContainer>
      </ContentWrapper>
    </SectionContainer>
  );
