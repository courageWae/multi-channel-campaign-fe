      ...
      <ContentWrapper>
        <TextWrapper>
          ...
          <Description>
            ...
            unique needs of the Education sector, driving growth through
            effective student recruitment and engagement across multiple
            channels.
          </Description>
          <Link to="/register">
        ...
        <ImageContainer>
          <img src={Images.learning} alt="hero-illustrator" />
        </ImageContainer>
      </ContentWrapper>
    </SectionContainer>
  );
