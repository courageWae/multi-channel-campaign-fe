  ...
  return (
    <SectionContainer>
      <ContentWrapper>
        ...
        <Subtitle>
          <div>
            <span className="text-orange-600">Operations and Management</span>{" "}
            ensures efficient coordination of processes, resources, and
            activities to achieve organizational goals and improve productivity.
          </div>
        </Subtitle>
        <OperationsContainer>
          <BackgroundImage
            src="https://images.unsplash.com/photo-1703021438438-fad8aa26d4c9?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            alt="background"
          />
          <Overlay />
          <OverlayContent>
...
const OperationsContainer = tw.div`
  relative w-full h-[800px] mt-20 overflow-hidden rounded-md
`;
