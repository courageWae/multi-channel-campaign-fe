      ...
      <Box>
        <Card
          style={{
            ...
            borderTop: "5px solid #7678ed",
            borderBottom:"2px solid #7678ed",
            borderRadius:"15px",
            ...
            <Box>
              <Box as="div" size="1" weight="bold">
                <Flex gap="2" align="center" style={{ color: data.titleColor }}>
                  <InputIcon width={24} height={24} style={{
                      marginRight: "5px",
                      padding: "5px",
                      background: "#7678ed",
                      color: "#ffffff",
                  ...
                  <Text weight="bold" size="1" style={{color:'#7678ed'}}>
                    Free Text Answer
                  </Text>
                </Flex>
              </Box>
              <hr style={{borderTop:"1px solid #7678ed",margin:"5px 0"}}/>
              <Text
                as="div"
                size="1"
                color="gray"
