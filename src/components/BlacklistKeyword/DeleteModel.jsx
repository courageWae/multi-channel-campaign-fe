...
const UploadModel = ({
    ...
    const DeleteDevice = () => {
        deleteMutate({ keywordId: selectedData })
    };

    return (
        <Model width={"w-full max-w-md"} setOpenModel={setDeleteModel} title="Delete Keyword">
            {deleteLoading && <Loading />}
            {!deleteLoading && (
                <>
                    {/* <Title>Are you sure?</Title> */}
                    <SubTitle>You are about to delete selected keyword. Deleting keyword is permanent and cannot be undone.</SubTitle>
