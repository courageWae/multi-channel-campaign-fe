...
const UploadModel = ({
    ...
    const DeleteDevice = () =>
        deleteDeviceMutate({ contactId: deviceId?.id, groupId: deviceId?.group_id });

    return (
        <Model width={"w-11/12 max-w-md"} setOpenModel={setOpenDeleteModel} title="Delete contact">
            ...
            {!deleteDeviceLoading && (
                <>
                    ...
                    <div className="w-full flex items-center justify-end space-x-10 mt-8">
                        <CancelBtn onClick={() => setOpenDeleteModel(false)}>Cancel</CancelBtn>
