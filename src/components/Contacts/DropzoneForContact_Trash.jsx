...
const Uploader = ({
    ...
    <div
        {...getRootProps()}
        className="w-full h-full bg-gray-50 rounded-md border border-gray-200 border-dashed   "
    >
        <input {...getInputProps()} />
...
${(p) => (p.$isDragActive ? "bg-gray-400" : " bg-gray-100")}
 upload-fonts w-full  rounded-lg  text-gray-600 flex flex-col items-center py-4 px-3 gap-0 my-2 cursor-pointer md:text-xs md:gap-2 md:px-8 md:py-5
`;
