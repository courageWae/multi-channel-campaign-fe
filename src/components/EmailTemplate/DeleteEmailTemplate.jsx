...
const DeleteEmailTemplate = ({
    setDeleteModel,
    deleteEmailTemplateMutate,
    deleteEmailTemplateLoading,
    selectedData,
}) => {
    const DeleteTemplate = () => {
        deleteEmailTemplateMutate({templateId: selectedData });
    }

    return (
        <Model width={"w-11/12 max-w-md"} setOpenModel={setDeleteModel}>
            <Title>Are you sure?</Title>
            <SubTitle>Are you sure want to delete this Template? This action can't be undone.</SubTitle>
