        ...
        <SectionContainer>
            <ContentWrapper>
                <TextWrapper>
                    ...
                    <Description>
                    Allows marketers to target subscribers based on their physical location or proximity to specific landmarks or areas of interest, ensuring that messages are delivered to the right audience at the right time.   
                                         </Description>
                    <Link to="/register">
