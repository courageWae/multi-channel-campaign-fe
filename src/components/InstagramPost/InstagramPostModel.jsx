...
import { MdOutlineEmojiEmotions, MdOutlineKeyboardArrowDown } from "react-icons/md";
import ScheduleModal from "./ScheduleModal";
import ExpandPreview from "components/FbPost/ExapandPreview";
import { Tooltip } from "react-tooltip";

const InstaPostModal = ({ onClose }) => {
    ...
    const isShareDisabled = images.length === 0 && videos.length === 0;
                ...
                <div className="flex flex-col w-full lg:w-2/3 bg-white rounded-md">
                    ...
                    <div className="flex">
                        <div className="w-[6%] pl-4 pt-1">
                            <FaInstagram className="w-5 h-5 text-[#F00276]" />
                        </div>
                        {showEmojiPicker && (
                            ...
                            <div className="px-4 py-2 border-b border-gray-300">
                                <div className="flex space-x-4">
                                    ...
                                    <label className="flex items-center space-x-2">
                                        ...
                                        />
                                        <span>Reel</span>
                                        <Tooltip id="reelTooltip" place="bottom" effect="solid">
                                    ...
                                    <label className="flex items-center space-x-2">
                                        ...
                                        />
                                        <span>Story</span>
                                        <Tooltip id="storyTooltip" place="bottom" effect="solid">
                            ...
                            {postType != "Story" && (
                                <AiWrap>
                                    ...
                                    <div className="relative">
                                        <EmojiButton onClick={handleEmojiButtonClick}><MdOutlineEmojiEmotions className="text-gray-600 mt-1 w-5 h-5 hover:text-black" title="Select Emoji" /></EmojiButton>
                                    </div>
                                </AiWrap>)}
                        </Body>
                    </div>
...
const ModalContainer = tw.div`z-10 addCommentModel fixed inset-0 flex items-center justify-center bg-black/30 backdrop-blur-sm bg-opacity-75 `;
