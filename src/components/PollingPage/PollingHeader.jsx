        ...
        <SectionContainer>
            <ContentWrapper>
                <TextWrapper>
                    ...
                    <Title>Polling, Surveys & Customer Feedback Management</Title>
                    <Description>
                    Brand Consistency: Ensures that surveys align with company branding, enhancing recognition and trust.                                         </Description>
                    <Link to="/register">
