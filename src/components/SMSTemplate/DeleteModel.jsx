...
const UploadModel = ({
    ...
    const DeleteDevice = () => {
        deleteMutate({ templateId: selectedData })
    };

    return (
        <Model width={"w-full max-w-md"} setOpenModel={setDeleteModel} title="Delete Template">
            {deleteLoading && <Loading />}
            {!deleteLoading && (
                <>
                    {/* <Title>Are you sure?</Title> */}
                    <SubTitle>You are about to delete selected template. Deleting template is permanent and cannot be undone.</SubTitle>
