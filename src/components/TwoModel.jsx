...
const TwoModel = ({ width, setOpenModel, title, children }) => {
    ...
    return (
        <Wrapper onClick={getCurrentTarget}>
            ...
            <PreviewBox $width={width} style={{ maxHeight: "80vh", overflowY: "auto" }}><div class="float-root pb-12">
                <p className="float-left text-xl text-pretty">
                    {title}
                </p>
...
${(p) => (p.$width ? ` bg-white ${p.$width} ` : " bg-white w-11/12 lg:w-2/5")}
mx-auto h-auto rounded-2xl px-8 pt-8 pb-8 relative z-20`;
