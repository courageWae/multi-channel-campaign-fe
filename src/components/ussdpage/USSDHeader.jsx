        ...
        <SectionContainer>
            <ContentWrapper>
                <TextWrapper>
                    ...
                    <Title>USSD Menu Builder Design (Drag & Drop)</Title>
                    <Description>
                        Allows users to visualize the menu flow and make immediate adjustments, ensuring the final design meets their expectations before going live                    </Description>
                    <Link to="/register">
