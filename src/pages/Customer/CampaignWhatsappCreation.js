...
// Main component
const CampaignWhatsappCreation = () => {
  ...
  const ScheduleFunction = async (values) => {
    return await axios.post(
      `${Config.apiUrl}/campaign/whatsapp/create`,
      values,
      {
        headers: {
    ...
    <Container>
      <Page>
        ...
        {step === 1 && (
          <Contents>
            <ContentHeader>
              <HeaderTitle>Create a Whatsapp campaign</HeaderTitle>
...
export default CampaignWhatsappCreation;
