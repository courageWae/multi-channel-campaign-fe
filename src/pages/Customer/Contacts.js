...
import AdminTable from "components/Contacts/Table";
...
import DeleteModel from "components/Contacts/DeleteModel";
import { useSelector } from "react-redux";
import GroupNameModel from "components/Contacts/GroupNameModel";
...
const Contacts = () => {
  ...
  const fetchFunction = async (values) =>
    await axios.post(`${Config.apiUrl}/getContactGroupList`, values, {
      headers: {
  ...
  const GroupNameFunction = async (values) => {
    ...
    body.append("groupName", values.name);

    return await axios.post(`${Config.apiUrl}/addContactGroup`, body, {
      headers: {
  ...
  const renameFunction = async (values) =>
    await axios.post(`${Config.apiUrl}/updateContactGroup`, values, {
      headers: {
        "Content-Type": "multipart/form-data",
        Token: `${user.token}`,
      },
          ...
          <Content>
            <ContentHeader>
              <div className="flex items-center justify-between">
                <HeaderTitle>Contact Groups</HeaderTitle>
                <Button
              ...
              <HeaderSubTitle>
                This is where you organize your group. Create, modify, and
                manage custom groups for targeted interactions.
              </HeaderSubTitle>
              <LearnMoreLink>
