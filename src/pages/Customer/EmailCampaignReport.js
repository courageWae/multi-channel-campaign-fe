...
import SemiCircularProgressBar from "../../components/EmailCampaign/SemiCircularProgressBar";
import html2canvas from "html2canvas";
import jsPDF from "jspdf";
import { FaDownload } from "react-icons/fa";
import { TiMessages } from "react-icons/ti";
import ViewMessageModal from "components/EmailCampaign/ViewMessageModal";

const EmailCampaignReport = () => {
  ...
  const fetchFunction = async () =>
    await axios.get(`${Config.apiUrl}/campaign/email/generate/report/${id}`, {
      headers: {
    ...
    <>
      <Container>
        <Page>
          <TopNavbar />
          {viewModal && (
            <ViewMessageModal setViewModel={setViewModal} data={reportData} />
          )}
