...
import Table from "components/Campaign/Table";
          ...
          <Content>
            <ContentHeader>
              <div className="flex items-center justify-between">
                <HeaderTitle>SMS Campaign</HeaderTitle>
                {user.type == Config.UserType.ClientUser && (
                  <Link to="/campaign/create/sms">
              ...
              <HeaderSubTitle>
                ...
                personalized, effective SMS campaigns.
              </HeaderSubTitle>
            </ContentHeader>
