...
import TelegramTable from "components/Campaign/TelegramTable";
  ...
  useEffect(() => {
    const handler = setTimeout(() => {
      getListMutate({
        ...
        type: Config.CampaignType.Telegram,
      });
    }, 500);
          ...
          <Content>
            <ContentHeader>
              <div className="flex items-center justify-between">
                <HeaderTitle>Telegram Campaign</HeaderTitle>
                {user.type == Config.UserType.ClientUser && (
                  <Link to="/campaign/create/telegram">
              ...
              <HeaderSubTitle>
                ...
                personalized, effective Telegram campaigns.
              </HeaderSubTitle>
            </ContentHeader>
