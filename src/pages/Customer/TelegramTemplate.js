...
import Table from "components/Messaging/TelegramTable";
...
const TelegramTemplate = () => {
  ...
  const fetchFunction = async (values) =>
    await axios.post(`${Config.apiUrl}/template/telegram/get`, values, {
      headers: {
          ...
          <Content>
            <ContentHeader>
              <div className="flex items-center justify-between">
                <HeaderTitle>Telegram Template</HeaderTitle>
                {user.type == Config.UserType.ClientUser && (
                  <Link to="/telegram-template-setup">
              ...
              <HeaderSubTitle>
                Boost business communication with customizable Telegram
