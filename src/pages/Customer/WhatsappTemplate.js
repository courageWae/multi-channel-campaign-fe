...
import Table from "components/Messaging/Table";
...
import DeleteModel from "components/Messaging/DeleteModel";
...
const Messaging = () => {
  ...
  const fetchFunction = async (values) =>
    await axios.post(`${Config.apiUrl}/template/whatsapp/get`, values, {
      headers: {
  ...
  const deleteFunction = async (values) =>
    await axios.post(
      `${Config.apiUrl}/template/whatsapp/delete`,
      values,
          ...
          <Content>
            <ContentHeader>
              <div className="flex items-center justify-between">
                <HeaderTitle>Whatsapp Template</HeaderTitle>
                {user.type == Config.UserType.ClientUser && (
                  <Link to="/whatsapp-template-setup">
              ...
              <HeaderSubTitle>
                Boost business communication with customizable WhatsApp
                templates for marketing, support, and updates. Quick and
                professional.
              </HeaderSubTitle>
              <LearnMoreLink>
